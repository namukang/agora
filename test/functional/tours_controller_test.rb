...
class ToursControllerTest < ActionController::TestCase
  ...
  test "should create tour" do
    assert_difference('Tour.count') do
      post :create, tour: { description: @tour.description, guide_id: @tour.guide_id, title: @tour.title }
    end
  ...
  test "should update tour" do
    put :update, id: @tour, tour: { description: @tour.description, guide_id: @tour.guide_id, title: @tour.title }
    assert_redirected_to tour_path(assigns(:tour))
  end
